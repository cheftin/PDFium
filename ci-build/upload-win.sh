  ...
  "attachments": [
    {
      ...
      "author_link": "https://cxan.kdr2.com/pdfium/windows-x64/",
      ...
      "fields": [
        {
          ...
          "value":"https://cxan.kdr2.com/pdfium/windows-${ARCH}/pdfium-windows-${ARCH}-${DATE}-${PDFium_SOURCE_REVIISON}${CONF}.zip"
        },
        {
          "short":true,
          "title":"Temporary Alias",
          "value":"https://cxan.kdr2.com/pdfium/windows-${ARCH}/pdfium-windows-${ARCH}-latest${CONF}.zip"
        }
      ]
    }
  ]
